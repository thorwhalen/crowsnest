...
(`PROMPT` by default; [`crowsnest.gists`](crowsnest.gists.md#module-crowsnest.gists) passes its own).
...
([`crowsnest.rows.RowContext`](crowsnest.rows.md#crowsnest.rows.RowContext)’s), so a line follows the item the person marks.
