...
[`crowsnest.watch`](crowsnest.watch.html.md#module-crowsnest.watch) learns things by polling the registry, which is honest but late
...
`<data dir>/events.jsonl`, which [`crowsnest.watch.events()`](crowsnest.watch.html.md#crowsnest.watch.events) tails – and, on a
...
about: [`crowsnest.ledger`](crowsnest.ledger.html.md#module-crowsnest.ledger) says why.
...
[`crowsnest.activity.read_activity()`](crowsnest.activity.html.md#crowsnest.activity.read_activity) rather than at the top of the module, which would
...
[`crowsnest.watch.tail_events()`](crowsnest.watch.html.md#crowsnest.watch.tail_events) does.
