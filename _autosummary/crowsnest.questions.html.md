...
- which homes to read ([`crowsnest.config.homes()`](crowsnest.config.html.md#crowsnest.config.homes)), and only their recent transcripts;
...
| [`ITEM_KIND`](#crowsnest.questions.ITEM_KIND)      | The marker a question row carries, which attention's identity and material read ([`crowsnest.attention.QUESTION`](crowsnest.attention.html.md#crowsnest.attention.QUESTION)).   |
|-----------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
`homes` are [`crowsnest.config.Home`](crowsnest.config.html.md#crowsnest.config.Home) (a `name` and a `path`). Returns one
