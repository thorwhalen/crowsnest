...
| [`QUESTION`](#crowsnest.attention.QUESTION)     | The `item_kind` of a question row ([`crowsnest.questions`](crowsnest.questions.md#module-crowsnest.questions)). |
...
The `item_kind` of a question row ([`crowsnest.questions`](crowsnest.questions.md#module-crowsnest.questions)).
...
A question row (`item_kind` [`QUESTION`](#crowsnest.attention.QUESTION), from [`crowsnest.questions`](crowsnest.questions.md#module-crowsnest.questions)) is
