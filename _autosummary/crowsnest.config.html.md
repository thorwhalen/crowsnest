...
| [`PublishSettings`](#crowsnest.config.PublishSettings)([to, command, console, refs]) | The `[publish]` table, validated: where the page goes ([`crowsnest.publish`](crowsnest.publish.html.md#module-crowsnest.publish)).                                                                                       |
