...
which [`crowsnest.ledger.update_ledger()`](crowsnest.ledger.html.md#crowsnest.ledger.update_ledger) overwrites, or the final section of the free
...
ledger last said – and then the ledger. openloops’ digest ([`crowsnest.tools.brief()`](crowsnest.tools.html.md#crowsnest.tools.brief),
...
([`crowsnest.ledger.read_ledger()`](crowsnest.ledger.html.md#crowsnest.ledger.read_ledger)’s shape); a session with no entry is classified
...
[`crowsnest.tools.brief()`](crowsnest.tools.html.md#crowsnest.tools.brief)’s openloops digest is the reader this order leaves room
