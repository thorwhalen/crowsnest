...
`activity` what [`crowsnest.activity.read_activity()`](crowsnest.activity.html.md#crowsnest.activity.read_activity) read of its tail (as a dict),
...
[`crowsnest.activity.describe_tool()`](crowsnest.activity.html.md#crowsnest.activity.describe_tool). A token or a home path cut there is a shape
