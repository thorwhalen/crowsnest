...
2. **The data directory** ([`crowsnest.paths.data_dir()`](crowsnest.paths.html.md#crowsnest.paths.data_dir)): where the ledgers and the
...
directory (`store`, else [`crowsnest.paths.data_dir()`](crowsnest.paths.html.md#crowsnest.paths.data_dir)), and reports the hooks.
