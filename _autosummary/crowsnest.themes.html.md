...
|---------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------|
| [`parents_of`](#crowsnest.themes.parents_of)(lineage)                  | `{session id: its parent's session id}` from [`crowsnest.lineage.graph()`](crowsnest.lineage.html.md#crowsnest.lineage.graph). |
...
`{session id: its parent's session id}` from [`crowsnest.lineage.graph()`](crowsnest.lineage.html.md#crowsnest.lineage.graph).
