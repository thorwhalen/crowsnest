...
[`crowsnest.lineage`](crowsnest.lineage.md#module-crowsnest.lineage) answers *who started whom*. This module is the half that makes
...
caller with nothing to hide, and [`crowsnest.report`](crowsnest.report.md#module-crowsnest.report) passes its page sanitiser so
...
`node` is the whole graph node. [`crowsnest.report`](crowsnest.report.md#module-crowsnest.report) passes a function that makes
